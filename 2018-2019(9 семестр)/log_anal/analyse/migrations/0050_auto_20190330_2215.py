# Generated by Django 2.1.3 on 2019-03-30 19:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('analyse', '0049_remove_vectorsoneversion_last_click'),
    ]

    operations = [
        migrations.CreateModel(
            name='VectorsOneVersion1',
            fields=[
                ...
                ('activity_time', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(default=0), default=[], size=None)),
